...
<!-- text fonts -->
<link rel="stylesheet" href="${request.contextPath}/assets/css/google-fonts.css"/>
<!-- ace styles -->
...
<link rel="stylesheet" href="${request.contextPath}/assets/css/jquery.gritter.css" />
<link rel="stylesheet" href="${request.contextPath}/assets/css/jquery-ui.min.css" />
<link rel="stylesheet" href="${request.contextPath}/assets/css/chosen.css" />
<!--[if lte IE 9]>
...
<script src="${request.contextPath}/assets/js/chosen.jquery.min.js"></script>
<script src="http://cdn.bootcss.com/mustache.js/2.2.1/mustache.js"></script>
<script type="text/javascript" src="${request.contextPath}/bootstrap3.3.5/js/bootstrap.min.js"></script>
