...
<div class="main-container" id="main-container">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/role/show" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            角色管理
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/aclModule/show" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            权限管理
                        </a>
                        <b class="arrow"></b>
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="/sys/dept/show" width="99%" style="min-height: 768px;"></iframe>
    </div>
    <!-- /.main-content -->
